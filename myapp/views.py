...
from myapp.forms import DataProductUploadFromUserForm, ObservatoryCreationForm
...
class TargetDetailView(PermissionRequiredMixin, DetailView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super().get_context_data(*args, **kwargs)
        data_product_upload_form = DataProductUploadFromUserForm(user=self.request.user,
            initial={
        ...
        context['data_product_with_user_form'] = data_product_upload_form
        return context
