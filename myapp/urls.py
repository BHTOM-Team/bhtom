...
urlpatterns = [
    ...
    path('targets/', BlackHoleListView.as_view(template_name='tom_common/bhlist.html'), name='bhlist'),
    path('targets/list', BlackHoleListView.as_view(template_name='tom_common/bhlist.html'), name='bhlist'),
